...
export const metadata: Metadata = {
  title: "Areas We Serve | 5 Star Movers Minnesota",
  description:
    "Explore the Twin Cities areas served by 5 Star Movers, including Minneapolis, St. Paul, Bloomington, Edina, Woodbury, and more.",
};
                  ...
                  {group.items.map((area) => (
                    ...
                    >
                      <Link href={`/areas/${area.slug}`} className="block">
                        ...
                        <div className="p-6">
                          <p
                            className="text-sm leading-[1.65] text-white/[0.68]"
                            style={{
                              display: "-webkit-box",
                              WebkitLineClamp: 4,
