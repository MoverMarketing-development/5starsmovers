...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildMetadata({
    fallbackTitle: "Moving Tips & Resources | 5 Star Movers Minnesota",
    fallbackDescription: "Expert moving advice, neighborhood guides, and relocation resources from Minnesota's most trusted movers.",
    pagePath: "/blog",
    seo,
  });
}
            ...
            >
              ...
              <div className="flex flex-col justify-center p-5 sm:p-8 lg:p-10">
                ...
                <div className="mt-6 flex items-center justify-between border-t border-white/8 pt-5">
                  <span className="text-sm text-white/40">{formatDate(featured.published_at ?? featured.created_at)}</span>
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-6">
                    ...
                    <div className="mt-5 flex items-center justify-between border-t border-white/6 pt-4">
                      <span className="text-xs text-white/35">{formatDate(post.published_at ?? post.created_at)}</span>
