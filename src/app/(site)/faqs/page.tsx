...
export async function generateMetadata(): Promise<Metadata> {
  const seo = await getSeoSettings("/faqs");
  return buildMetadata({
    fallbackTitle: "FAQ's | 5 Star Movers",
    fallbackDescription: "5-Star Movers can help move you and your family in & out of the Minneapolis area.",
    pagePath: "/faqs",
    seo,
  });
}
