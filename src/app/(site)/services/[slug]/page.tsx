...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!service) return {};
  const seo = await getSeoSettings(`/services/${slug}`);
  return buildMetadata({
    fallbackTitle: `${service.title} | 5 Star Movers Minnesota`,
    fallbackDescription: service.heroDescription,
  ...
  return (
    <main className="bg-background text-white">
      <ServiceJsonLd
        ...
        url={`https://www.5starmoversmn.com/services/${slug}`}
      />
      <BreadcrumbJsonLd items={[
        { name: "Home", url: "https://www.5starmoversmn.com" },
        { name: "Services", url: "https://www.5starmoversmn.com/services" },
        { name: service.title, url: `https://www.5starmoversmn.com/services/${slug}` },
      ]} />
