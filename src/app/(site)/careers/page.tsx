  ...
  return (
    <main className="overflow-x-hidden bg-background text-white">
      <section className="relative overflow-hidden border-b border-white/8 bg-[#121417]">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-14 text-center md:px-8 md:py-16">
          ...
          <h1 className="mx-auto mt-5 max-w-4xl font-display text-4xl font-extrabold leading-[0.95] text-white sm:text-5xl lg:text-7xl">
            Careers
          </h1>
          <p className="mx-auto mt-6 max-w-3xl text-base leading-[1.6] text-white/72">
      ...
      <section className="bg-[#121417] py-14 md:py-16">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 md:px-8 lg:grid-cols-[0.36fr_0.64fr]">
          <aside className="min-w-0 rounded-[1.6rem] border border-white/8 bg-[#171b1f] p-5 text-center sm:p-6">
            ...
            <p className="mx-auto mt-5 max-w-md text-base leading-[1.6] text-white/68">
              Learn more about our company by clicking here.
            </p>
            <div className="mt-6 flex justify-center">
              <Link
                href="/about-us"
                className="inline-flex w-full items-center justify-center rounded-full border border-white/10 px-4 py-3 text-center font-display text-[11px] font-extrabold uppercase tracking-[0.14em] text-white/76 hover:border-[#ffdc00]/45 hover:text-white sm:w-auto sm:px-5 sm:text-xs sm:tracking-[0.18em]"
              >
          ...
          <section className="min-w-0 rounded-[1.9rem] border border-[#016d63]/35 bg-[linear-gradient(135deg,rgba(1,109,99,0.16)_0%,rgba(18,20,23,1)_46%,rgba(18,20,23,1)_100%)] p-5 sm:p-6 md:p-8">
            <h3 className="text-center font-display text-3xl font-extrabold text-white">
              Contact Us
            </h3>
            ...
            <form className="mt-8 space-y-6">
              <div className="grid gap-5 md:grid-cols-2">
                <label className="grid gap-2 text-left">
                  ...
                  <input
                    type="text"
                    className="w-full min-w-0 rounded-2xl border border-white/10 bg-black/20 px-4 py-3 text-white placeholder:text-white/30"
                  />
                </label>
              ...
              <fieldset className="grid gap-3 rounded-[1.5rem] border border-white/10 bg-black/10 p-5 text-left">
              ...
              <label className="grid gap-2 text-left">
                ...
                <textarea
                  rows={4}
                  className="w-full min-w-0 rounded-[1.5rem] border border-white/10 bg-black/20 px-4 py-3 text-white placeholder:text-white/30"
                />
              </label>
              ...
              <label className="grid gap-2 text-left">
                ...
                <div className="rounded-[1.5rem] border border-dashed border-white/15 bg-black/20 px-4 py-6 text-center text-sm text-white/58">
                  <input type="file" className="block w-full min-w-0 text-sm text-white/70 file:mb-3 file:mr-0 file:block file:w-full file:rounded-full file:border-0 file:bg-[#ffdc00] file:px-4 file:py-2 file:text-center file:font-display file:text-xs file:font-extrabold file:uppercase file:tracking-[0.14em] file:text-[#121417] sm:file:mb-0 sm:file:mr-4 sm:file:inline-block sm:file:w-auto sm:file:tracking-[0.18em]" />
              ...
              <div className="rounded-[1.5rem] border border-[#016d63]/35 bg-[#016d63]/12 p-5 text-left">
              ...
              <div className="rounded-[1.5rem] border border-white/8 bg-black/15 p-5 text-left">
      ...
      <section className="relative overflow-hidden border-y border-white/6 bg-[#016d63] py-14 md:py-16">
        ...
        <div className="relative mx-auto max-w-6xl px-4 text-center md:px-8">
          ...
          <div className="mt-10">
            <Link
              href="/quote"
              className="inline-flex w-full items-center justify-center rounded-full bg-[#ffdc00] px-6 py-4 text-center font-display text-sm font-extrabold uppercase tracking-[0.16em] text-[#121417] transition-all hover:scale-[1.02] hover:bg-[#ffe75a] sm:w-auto sm:px-8 sm:tracking-[0.2em]"
            >
