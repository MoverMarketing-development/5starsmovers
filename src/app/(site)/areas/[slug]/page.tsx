...
import { AreaServiceJsonLd, BreadcrumbJsonLd } from "@/components/JsonLd";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!area) return {};
  const seo = await getSeoSettings(`/areas/${slug}`);
  return buildMetadata({
    fallbackTitle: `${area.city} Movers | 5 Star Movers Minnesota`,
    fallbackDescription: area.heroDescription,
    pagePath: `/areas/${slug}`,
    seo,
  });
}
  ...
  return (
    <main className="bg-background text-white">
      <AreaServiceJsonLd
        ...
        url={`https://www.5starmoversmn.com/areas/${slug}`}
      />
      <BreadcrumbJsonLd items={[
        { name: "Home", url: "https://www.5starmoversmn.com" },
        { name: "Areas We Serve", url: "https://www.5starmoversmn.com/areas" },
        { name: `${area.city} Movers`, url: `https://www.5starmoversmn.com/areas/${slug}` },
      ]} />
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 md:px-8 md:py-20 lg:py-24">
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div className="text-center lg:text-left">
              ...
              <p className="mx-auto mt-6 max-w-2xl text-base leading-[1.6] text-white/[0.68] lg:mx-0 lg:text-lg">{area.heroDescription}</p>
            ...
            <div className="glass-panel ambient-shadow rounded-[2rem] border border-white/10 p-6 text-center lg:p-7 lg:text-left">
              ...
              <p className="mt-4 text-base leading-[1.6] text-white/58">Enter your route and we will carry both addresses into the full quote form automatically.</p>
      ...
      <section className="border-b border-white/5 bg-[#111417] py-16 md:py-20 lg:py-24">
        <div className="mx-auto grid max-w-7xl gap-12 px-4 md:px-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          ...
          <div className="order-1 text-center lg:order-2 lg:text-left">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-base leading-[1.65] text-white/[0.68] lg:mx-0 lg:text-lg">{area.citySectionBody}</p>
      ...
      <section className="border-b border-white/5 bg-[#ffdc00] py-16 text-[#121417] md:py-20 lg:py-24">
        <div className="mx-auto grid max-w-7xl gap-12 px-4 md:px-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          <div className="order-1 text-center lg:text-left">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-base leading-[1.65] text-[#121417]/80 lg:mx-0">{area.sectionTwoBody}</p>
          </div>
      ...
      <section className="border-b border-white/5 bg-[#f8f6ef] py-16 text-[#121417] md:py-20 lg:py-24">
        <div className="mx-auto grid max-w-7xl gap-12 px-4 md:px-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          ...
          <div className="order-1 text-center lg:order-2 lg:text-left">
            ...
            <p className="mx-auto mt-6 max-w-3xl text-base leading-[1.65] text-[#121417]/80 lg:mx-0">{area.sectionThreeBody}</p>
          </div>
        </div>
      </section>
